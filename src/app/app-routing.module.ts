...
import { PurchaseOrderManagementComponent } from "./dashboard/purchase-order-management/purchase-order-management.component";
import { InventoryManagementComponent } from "./dashboard/inventory-management/inventory-management.component";
import { IssueInventoryComponent } from "./dashboard/issue-inventory/issue-inventory.component";
...
const appRoutes: Routes = [
    ...
    { path: '404', component: NotFoundComponent },
    {
        ...
        children: [
            ...
            { path: 'purchaseodermanagement', component: PurchaseOrderManagementComponent },
            { path: 'issueinventory', component: IssueInventoryComponent },
