...
export class LookupComponent implements OnInit {
  ...
  constructor(
    ...
    private _entityList_: EntityList, private _lookup_: LookupService , private _onFail_ : OnFailService) {
    this.columnDefs = [
      {
        headerName: "#",
  ...
  getAllentitylist(){
    this._entityList_.get().subscribe(res => {
      if(res)
      {
        console.log('====================================');
        console.log(res);
        this.entityList = res;
        this.getLookup(res[0]);
        console.log('====================================');
      }
    } , error => {
      console.error(error);
  ...
  getLookup(data){
    ...
    console.log(data);
    console.log('====================================');
    this._lookup_.getall().subscribe(res => {
      if(res)
      {
        console.log('====================================');
        console.log(res);
